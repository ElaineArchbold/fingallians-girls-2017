...
const SQUAD_LABEL = SQUAD === "2017" ? "Fingallians Girls · 2017" : "Fingallians Girls · 2015";
...
const WEEKS_2015 = [
  ...
  },
  {
    ...
    speed:[{id:"s6a",label:"⚡ Butt Kicks",desc:"Practise for 10 minutes at least once this week. Learn the name: Butt Kicks. Heel to backside on every stride — improves hamstring activation and stride cycle. Coaches will use this term in training.",youtube_id:"p7OBdAJ2017E8"}],
    skills:[
...
const WEEKS_2017 = [
  ...
  },
  {
    week:6, phase:"Push", dates:"Aug 3–9",
    runs:[{label:"Run 1",distance:"1.5k"},{label:"Run 2",distance:"2k"},{label:"Run 3",distance:"2k"}],
    speed:[{id:"s6a",label:"⚡ Butt Kicks",desc:"Run on the spot and kick your heels up to your bottom as fast as you can. Practice for 10 minutes. Learn the name: Butt Kicks!",youtube_id:"p7OBdAJ2017E8"}],
    skills:[
