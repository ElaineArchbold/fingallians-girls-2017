...
const WEEKS_2015 = [
  {
    ...
    skills:[
      {id:"c1a",label:"🏑 Roll Lift",desc:"15 mins: roll the sliotar along the ground and scoop it up cleanly with the hurl. Practise off both sides. How many in a row can you do without dropping it?",youtube_id:"uO5Z21QjPMQ"},
    ...
    squad:{label:"Squad Session – Roll Lift & Kick-Pass",desc:"Get 3–4 girls together. First 10 mins: camogie roll lift relay — take turns scooping the sliotar cleanly, count your best streak. Then 10 mins: football kick-pass pairs, count clean catches. Record both scores!",youtube_id:"pm5sdhJcd-Q"},
  },
  {
    ...
    skills:[
      {id:"c2a",label:"🏑 Strike from the Hand",desc:"20 mins at the ball wall: striking off both sides, aim for below shoulder height. Count clean strikes in a row — try to beat your score each session.",youtube_id:"jzwskF82xIk"},
...
const WEEKS_2017 = [
  {
    ...
    skills:[
      {id:"c1a",label:"🏑 Roll Lift",desc:"Roll the sliotar along the ground and scoop it up with your hurl. Try both sides! How many can you do in a row without dropping it?",youtube_id:"uO5Z21QjPMQ"},
    ...
    squad:{label:"Squad Session – Roll Lift & Kick-Pass",desc:"Get 3–4 girls together! (1) Practice Fall Forward — who has the best lean? Make each other laugh trying! (2) Camogie: roll lift relay — roll the sliotar and take turns scooping it up cleanly, count your streak. (3) Football: kick-pass to a partner, count clean catches. Have fun with it! 🏑⚽",youtube_id:"pm5sdhJcd-Q"},
  },
  {
    week:2, phase:"Foundation", dates:"Jul 6–12",
    ...
    skills:[
      {id:"c2a",label:"🏑 Strike from the Hand",desc:"Head to the ball wall and strike the sliotar off both sides. See how many clean strikes you can do in a row — try to beat your score each time!",youtube_id:"jzwskF82xIk"},
    ...
    squad:{label:"Squad Session – Arm Swing & Striking",desc:"Get your crew together! (1) Stationary Arm Swing race — who has the best technique? (2) Camogie: striking relay — take turns at the wall, count clean strikes in a row, cheer each other on! (3) Football: solo and dummy — have a go and see how many clean ones you can do together!",youtube_id:"UEFHWItrOD0"},
  },
  {
    week:3, phase:"Building", dates:"Jul 13–19",
    runs:[{label:"Run 1",distance:"1k"},{label:"Run 2",distance:"1.5k"},{label:"Run 3",distance:"1.5k"}],
